<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column min-width="150px" label="组件">
        ...
        <el-tabs v-model="activeName">
          <el-tab-pane label="基本" name="first">
            ...
            <el-form-item label="组件图片" prop="image">
              <el-upload class="upload-demo" :file-list="form.fileList" action="http://eolinker.mctag.cn/server/index.php?g=Web&c=Mock&o=simple&projectID=10&uri=http://192.168.159.1:8765/uploadFile"
                :on-preview="handlePreview" :on-remove="handleRemove" :on-success="handleSuccess" list-type="picture" :limit="1"
            ...
            <el-form-item label="提供商">
              <template slot-scope="scope">
                <el-select v-model="form.shopId" placeholder="请选择" style="width:100%;">
                  <el-option v-for="item in options1" :key="item.shopId" :label="item.shopName" :value="item.shopId">
                  </el-option>
                </el-select>
              </template>
            </el-form-item>
          ...
          <el-tab-pane label="关键组件" name="third">
            <el-table :key='tableKey' :data="form.productVos" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
              style="width: 100%">
              <el-table-column min-width="150px" label="可替组件名称">
                <template slot-scope="scope">
                  <el-select v-model="scope.row.productIds" multiple placeholder="请选择" style="width:100%;">
