        ...
        <el-tabs v-model="activeName">
          <el-tab-pane label="基本" name="first">
            ...
            <el-form-item label="商品图片" prop="image">
              <el-upload class="upload-demo" :file-list="form.fileList" action="http://eolinker.mctag.cn/server/index.php?g=Web&c=Mock&o=simple&projectID=10&uri=http://192.168.159.1:8767/background/setSampleStatus"
                :on-preview="handlePreview" :on-success="handleSuccess" :on-remove="handleRemove" list-type="picture"
                :auto-upload="autoupload" :before-upload="beforeAvatarUpload" @on-change="changeImage">
