...
export const asyncRouterMap = [
  ...
  //   alwaysShow: true,
  //   meta: { title: '方案', icon: 'documentation', roles: ['admin', 'editor'] },
  //   children: [
  //     {
  //       path: 'page',
  //       component: _import('permission/page'),
  //       name: 'pagePermission',
  //       meta: { title: '出售中', roles: ['admin'] }
  //     },
  //     {
  //       path: 'directive',
  ...
  //     {
  //       path: 'recycle',
  //       component: _import('permission/recycle'),
  //       name: 'recyclePermission',
  //       meta: { title: '回收站' }
  //     }
  //   ]
  // },
  ...
  //     {
  //       path: 'c-sell',
  //       component: _import('components-demo/c-sell'),
  //       name: 'c-sell-demo',
  //       meta: { title: '出售中' }
  //     },
  //     {
  //       path: 'c-sold',
  //       component: _import('components-demo/c-sold'),
  //       name: 'c-sold-demo',
  //       meta: { title: '已售罄' }
  //     },
  //     {
  //       path: 'c-warehouse',
  //       component: _import('components-demo/c-warehouse'),
  //       name: 'c-warehouse-demo',
  //       meta: { title: '仓库中' }
  //     },
  //     {
  //       path: 'c-recycle',
  //       component: _import('components-demo/c-recycle'),
  //       name: 'c-recycle-demo',
  //       meta: { title: '回收站' }
  //     }
  //   ]
